...
class ReviewController extends Controller
{
  ...
  public function index(Request $request,$id)
  {
    ...
    return \App\Http\Resources\Api\Item\Reviews::collection($reviews->paginate(1)->setPath("/item/{$item->slug}/$id"))->additional(['ratings'=>$this->data]);
  }
  public function myReviews(){
    $reviews = ItemReview::where('user_id', $this->uid())->get();
    return Reviews::collection($reviews)->additional(['totalReviews'=>count($reviews)]); 
  }
  public function edit($id)
  {
    ...
    $this->data['item']=new Items(Item::where(['id'=>$id])->first());
