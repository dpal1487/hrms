        ...
        <div class="w-100">
            ...
            <div class="mb-10 fv-row">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <!--begin::Option-->
                        <!-- {{ form.account_team_size }} -->
                        <label
                            :class="`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${form.account_team_size === '1-1' ? 'active' : ''}  `">
                            <input type="radio" class="btn-check" v-model="form.account_team_size"
                                :checked="(form.account_team_size === '1-1') && 'checked'" value="1-1" />
                    ...
                    <div class="col">
                        <!--begin::Option-->
                        <label
                            :class="`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${form.account_team_size === '2-10' ? 'active' : ''}  `">
                            <input type="radio" class="btn-check" v-model="form.account_team_size"
                                :checked="(form.account_team_size === '2-10') && 'checked'" value="2-10" />
                    ...
                    <div class="col">
                        <!--begin::Option-->
                        <label
                            :class="`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${form.account_team_size === '10-50' ? 'active' : ''} `">
                            <input type="radio" class="btn-check" v-model="form.account_team_size"
                                :checked="(form.account_team_size === '10-50') && 'checked'" value="10-50" />
                    ...
                    <div class="col">
                        <!--begin::Option-->
                        <label
                            :class="`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${form.account_team_size === '50+' ? 'active' : ''} `">
                            <input type="radio" class="btn-check" v-model="form.account_team_size"
                                :checked="(form.account_team_size === '50+') && 'checked'" value="50+" />
