...
<template>
    <div class="d-flex flex-column flex-lg-row-auto w-lg-300px w-xl-450px">
        <div class="d-flex flex-column position-lg-fixed top-0 bottom-0 w-lg-300px w-xl-450px scroll-y bgi-size-cover bgi-position-center"
            ...
            <div class="d-flex flex-row-fluid justify-content-center p-10">
                ...
                <div class="stepper-nav">
                    <!--begin::Step 1-->
                    <div :class="`stepper-item ${currStep > 0 ? 'completed' : currStep === 0 ? 'current' : 'pending'}`"
                    ...
                    <!--end::Step 1-->
                    <!--begin::Step 2-->
                    <div :class="`stepper-item ${currStep > 1 ? 'completed' : currStep === 1 ? 'current' : 'pending'}`"
                        data-kt-stepper-element="nav">
                        <!--begin::Wrapper-->
                        <div class="stepper-wrapper">
                            <!--begin::Icon-->
                    ...
                    <!--end::Step 2-->
                    <!--begin::Step 3-->
                    <div :class="`stepper-item ${currStep > 2 ? 'completed' : currStep === 2 ? 'current' : 'pending'}`"
                        data-kt-stepper-element="nav">
                        <!--begin::Wrapper-->
                        <div class="stepper-wrapper">
                            <!--begin::Icon-->
                    ...
                    <!--end::Step 3-->
                    <!--begin::Step 4-->
                    <div :class="`stepper-item ${currStep > 3 ? 'completed' : currStep === 3 ? 'current' : 'pending'}`"
                        data-kt-stepper-element="nav">
                        <!--begin::Wrapper-->
                        <div class="stepper-wrapper">
                            <!--begin::Icon-->
                    ...
                    <!--end::Step 4-->
                    <!--begin::Step 5-->
                    <div :class="`stepper-item ${currStep > 4 ? 'completed' : currStep === 4 ? 'current' : 'pending'}`"
                        data-kt-stepper-element="nav">
                        <!--begin::Wrapper-->
                        <div class="stepper-wrapper">
                            <!--begin::Icon-->
