...
<template>
    <div :class="`modal fade ${show ? 'show d-block mybackdrop' : 'd-none'}`" id="kt_modal_two_factor_authentication"
        tabindex="-1" :aria-hidden="show ? false : true">
        <!--begin::Modal header-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header flex-stack">
                    ...
                    <!--end::Title-->
                    <!--begin::Close-->
                    <button type="button" @click="$emit('hidemodal')" class="btn btn-sm btn-icon btn-active-color-primary"
                ...
                <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
                    ...
                    <div class="d-none" data-kt-element="sms">
                        ...
                        <!--end::Heading-->
                        <!--begin::Notice-->
                        <div class="text-muted fw-semibold mb-10">Enter your mobile phone number with country code and we
