...
export default defineComponent({
    props: ['invoice', 'companies', 'clients', 'address', 'currencies'],
    setup() {
    ...
    methods: {
            ...
            await axios
                ...
                .then((response) => {
                    if (response.data.success = true) {
                        this.clientAddress = response?.data?.data || {}
                        return;
                    }
                })
        },
        async getCompanyDetails(id) {
            await axios
                ...
                .then((response) => {
                    if (response.data.success = true) {
                        this.companyAddress = response?.data?.data || {}
                        return;
                    }
                })
        },
        async getCurrencyValue(id) {
            await axios
                .get(id + '/currency-value')
                .then((response) => {
                    if (response.data.success = true) {
                        this.CurrencyValue = response?.data?.data || {}
                        return;
                    }
                })
        }
    ...
    watch: {
        form: {
            ...
            handler() {
                ...
                this.form.total_amount = total * this.CurrencyValue?.inr_amount;
                                    ...
                                    <div class="d-flex align-items-center flex-equal fw-row me-4 order-2 gap-4"
                                        ...
                                        <div class="position-relative d-flex align-items-center w-150px ">
                                            ...
                                            <VueDatePicker v-model="v$.form.invoice_date.$model" :enable-time-picker="false"
                                                auto-apply input-class-name="form-control form-control-solid fw-bold pe-5"
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="d-flex flex-wrap gap-6 justify-content-between">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="mb-1">
                                                <!--begin::Select-->
                                                <Multiselect :options="companies.data" label="company_name" valueProp="id"
                                            ...
                                            <div class="d-flex mt-6 flex-column gap-2 text-gray-600 fs-5">
                                                <span> {{ this.companyAddress?.address_line_1 }} </span>
                                                <span> {{ this.companyAddress?.address_line_2 }}</span>
                                                <span> {{ this.companyAddress?.city }}</span>
                                                <span> {{ this.companyAddress?.state }}</span>
                                                <span> {{ this.companyAddress?.country?.name }}</span>
                                                ...
                                                <tr
                                                    ...
                                                    <th colspan="4" class="border-bottom border-bottom-dashed ps-0">
                                                        <div class="d-flex align-items-start justify-content-between">
                                                            <div class="fs-5 h-40px">Net payable amount <span class="fs-6"
                                                                    v-if="(this.form.total)">{{
                                                                        this.CurrencyValue.symbols }}
                                                                    {{ this.form.total }} </span> <span v-else>{{
                                                                        this.CurrencyValue.symbols }} 00</span>
                                                                X
                                                                <span class="fs-6"
                                                                    v-if="(this.CurrencyValue?.inr_amount)">{{
                                                                        this.CurrencyValue?.inr_amount }} INR</span>
                                                                <span class="fs-6"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea name="notes" class="form-control form-control-solid" rows="3"
                                            placeholder="Thanks for your business" v-model="v$.form.notes.$model" :class="v$.form.notes.$errors.length > 0
                                                ? 'is-invalid'
                                                : ''
                                                "></textarea>
                                    </div>
                    ...
                    <div class="card position-sticky top-0">
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="mb-10">
                                ...
                                <jet-input v-else type="text" :value="this.CurrencyValue?.inr_amount"
                                    placeholder="Conversion Rate" />

                                <jet-input v-else type="text" v-model="conversion_rate" placeholder="Conversion Rate" />
                            ...
                            <div class="mb-4">
                                ...
                                <Multiselect :options="status" label="name" valueProp="id"
                                    class="form-control form-control-lg form-control-solid" :class="v$.form.status.$errors.length > 0
                                        ? 'is-invalid'
                                        : ''
                                        " placeholder="Select One" v-model="v$.form.status.$model" track-by="name" />
