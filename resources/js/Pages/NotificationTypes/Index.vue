...
export default defineComponent({
    ...
    methods: {
        async confirmDelete(id, index) {
            this.isLoading = true;
            await utils.deleteIndexDialog(route('notification-type.destroy', id), this.notificationtypes.data, index);
        ...
        async changeStatus(status, id) {
            this.isLoading = true;
            await utils.changeStatus(route('notification-type.status'), { id: id, status: status });
            this.isLoading = false;
        },
...
<template>
    ...
    <app-layout :title="title">
        <template #breadcrumb>
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">Notification Types</span>
            </li>
        </template>
        <template #toolbar>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link href="/notification-type/create" class="btn btn-sm fw-bold btn-primary">
                <i class="bi bi-plus-circle"></i>Add New Notification</Link>
            </div>
        </template>
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <div class="table-responsive">
                    <table class="table align-center table-row-dashed fs-6 gy-5 text-center">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr v-for="(notificationtype, index) in notificationtypes.data" :key="index">
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-end"
                    v-if="notificationtypes.meta">
                    <Pagination :links="notificationtypes.meta.links" />
                </div>
            </div>
        </div>
    </app-layout>
