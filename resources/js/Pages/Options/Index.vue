...
export default defineComponent({
    ...
    methods: {
        async confirmDelete(id, index) {
            this.isLoading = true;
            await utils.deleteIndexDialog(route('option.destroy', id), this.options.data, index);
        ...
        async changeStatus(status, id) {
            console.log(id)
            this.isLoading = true;
            await utils.changeStatus(route('option.status'), { id: id, status: status });
            this.isLoading = false;
        },
    ...
    <app-layout :title="title">
        ...
        <template #toolbar>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link href="/option/create" class="btn btn-sm fw-bold btn-primary">
                                ...
                                <td>
                                    ...
                                    <div class="d-flex">
                                        <span
                                            ...
                                            <img v-if="option?.image" :src="option?.image" alt="image"
                                                class="rounded" />
