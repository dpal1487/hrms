    ...
    methods: {
        ...
        async onSettingImage(e) {
            ...
            if (data.response.success) {
                ...
                this.form.option_value = data.response.data?.base_path;
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="fv-row mb-2">
                                    <DropFile :image="option?.data?.image?.file_path" :isUploading="option?.isLoading"
                                        @change="onSettingImage" />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end m-5 gap-5">
                            ...
                            <button type="submit" class="btn btn-primary" :class="{ 'text-white-50': form.processing }">
                                ...
                                <span v-if="route().current() == 'option.edit'">Update</span>
                                <span v-if="route().current() == 'option.create'">Save</span>
                            </button>
                        </div>
                    </div>
                </form>
