                                    ...
                                    <div class="modal-body scroll-y mx-5 my-7">
                                        ...
                                        <form id="kt_modal_update_role_form"
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                data-kt-scroll-offset="300px" style="max-height: 489px;">
                                                <!--begin::Input group-->
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="text-end min-w-100px sorting_disabled" rowspan="1"
                                                        colspan="1" aria-label="Actions" style="width: 148.125px;">
                                                        Actions</th>
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <!--end::user=-->
                                                    <!--begin::Joined date=-->
                                                    <td data-order="2022-02-21T06:43:00+05:30">21 Feb 2022, 6:43 am
                                                    </td>
                                                    <!--end::Joined date=-->
                                                    <!--begin::Action=-->
                                                    <td class="text-end">
                                                ...
                                                <tr class="even">
                                                    ...
                                                    <!--end::user=-->
                                                    <!--begin::Joined date=-->
                                                    <td data-order="2022-08-19T06:43:00+05:30">19 Aug 2022, 6:43 am
                                                    </td>
                                                    <!--end::Joined date=-->
                                                    <!--begin::Action=-->
                                                    <td class="text-end">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <!--end::user=-->
                                                    <!--begin::Joined date=-->
                                                    <td data-order="2022-06-24T20:43:00+05:30">24 Jun 2022, 8:43 pm
                                                    </td>
                                                    <!--end::Joined date=-->
                                                    <!--begin::Action=-->
                                                    <td class="text-end">
                                                ...
                                                <tr class="even">
                                                    ...
                                                    <!--end::user=-->
                                                    <!--begin::Joined date=-->
                                                    <td data-order="2022-11-10T22:10:00+05:30">10 Nov 2022, 10:10 pm
                                                    </td>
                                                    <!--end::Joined date=-->
                                                    <!--begin::Action=-->
                                                    <td class="text-end">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <!--end::user=-->
                                                    <!--begin::Joined date=-->
                                                    <td data-order="2022-09-22T11:30:00+05:30">22 Sep 2022, 11:30 am
                                                    </td>
                                                    <!--end::Joined date=-->
                                                    <!--begin::Action=-->
                                                    <td class="text-end">
                                            ...
                                            <div class="dataTables_paginate paging_simple_numbers"
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <li class="paginate_button page-item next"
                                                        id="kt_roles_view_table_next"><a href="#"
                                                            aria-controls="kt_roles_view_table" data-dt-idx="4" tabindex="0"
