                                                ...
                                                <div class="d-flex flex-wrap d-grid gap-5 gap-xxl-9">
                                                    ...
                                                    <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100"
                                                        ...
                                                        <div class="card-body text-center">
                                                            <!--begin::Food img  src="/assets/media/stock/food/img-2.jpg"-->
                                                            <img :src="image.medium_path"
                                                                ...
                                                                <div class="text-center">
                                                                    <span
                                                                        class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-3 fs-xl-1">{{
                                                                            image?.small_path?.split("/images/")[1] }}</span>
                                                                    <span
                                                                        class="text-gray-400 fw-semibold d-block fs-6 mt-n1">16
                                                                        mins to cook</span>
                                                                </div>
                                                                <!--end::Title-->
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="kt_pos_food_content_2">
                                                ...
                                                <div class="d-flex flex-wrap d-grid gap-5 gap-xxl-9">
                                                    ...
                                                    <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                                        ...
                                                        <div class="card-body text-center">
                                                            <!--begin::Food img-->
                                                            <img src="/assets/media/stock/food/img-11.jpg"
                                                                class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                                alt="" />
                                                            <!--end::Food img-->
                                                            <!--begin::Info-->
