    ...
    methods: {
        submit(form) {
            ...
            this.form
                ...
                .post(this.route('menuItem.store'), {
                    onSuccess: (data) => {
    ...
    <app-layout :title="title">
        <template #breadcrumb>
            ...
            <li class="breadcrumb-item text-muted">
                <a href="/menus" class="text-muted text-hover-primary">Menus</a>
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-400 w-5px h-2px"></span>
            </li>
        ...
        <div class="row mb-5">
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- end page title -->
                        <menu-item-form @submitted="submit" :menu_lists="menu_lists?.data" :parents="parents">
                            <template #action>
