                        ...
                        <div class="card-body p-0 tab-pane fade show active">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-bordered align-middle gy-4 gs-9">
                                    <thead
                                        class="text-uppercase border-bottom border-gray-200 fs-6 text-gray-600 fw-bold bg-light bg-opacity-75 text-center">
                                        <tr>
                                    ...
                                    <tbody class="fw-bold text-gray-800 fs-5 text-center">
                                                    ...
                                                    <ul class="dropdown-menu text-small menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <!-- <li class="menu-item px-3">
                                                            <Link
                                                                ...
                                                                :href="`/company/${supplier?.id}/edit`">Edit
                                                            </Link>
                                                        </li> -->
                                                        <li class="menu-item px-3">
                                                            <Link
                                                                class="btn btn-sm dropdown-item align-items-center justify-content-center"
                                                                :href="`/company/${supplier?.id}`">View
                                                            </Link>
                                                        </li>
                                ...
                                <table class="table table-row-bordered align-middle gy-4 gs-9">
                                    <thead
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-w-150px">supplier</td>
                                            <td></td>
                                        </tr>
                                    </thead>
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            <td>Aug 01, 2021</td>
                                            <td>
                                                <a href="#">supplier for July 2022</a>
                                            </td>
                                            <td>$142.80</td>
                                            <td>
                                                <a href="#" class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                ...
                                <table class="table table-row-bordered align-middle gy-4 gs-9">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            <td>Jun 01, 2021</td>
                                            <td>
                                                <a href="#">supplier for May 2022</a>
                                            </td>
                                            <td>$123.79</td>
                                            <td>
                                                <a href="#" class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
