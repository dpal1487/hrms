    ...
    <div class="" >
        ...
        <div class="w-100">
            ...
            <div class="d-flex flex-column mb-7 fv-row">
                ...
                <!--end::Label-->
                <input type="text" class="form-control form-control-solid" placeholder="" v-model="form.card_name"
                    />
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            ...
            <div class="row mb-10">
                ...
                <div class="col-md-8 fv-row">
                    ...
                    <div class="row fv-row">
                        <!--begin::Col-->
                        <div class="col-6">
                            <select v-model="card_expiry_month" class="form-select form-select-solid" data-control="select2"
                        ...
                        <!--begin::Col-->
                        <div class="col-6">
                            <select v-model="card_expiry_year" class="form-select form-select-solid" data-control="select2"
                ...
                <div class="col-md-4 fv-row">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control form-control-solid" minlength="3" maxlength="4"
                            placeholder="CVV" v-model="form.card_cvv" />
                        <!--end::Input-->
                        <!--begin::CVV icon-->
            ...
            <div class="d-flex flex-stack">
                ...
                <label class="form-check form-switch form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" v-model="form.card_save"
                                    :checked="(form.card_save === '1') && 'checked'"/>
