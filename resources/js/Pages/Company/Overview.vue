                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <span class="fw-bold fs-6 text-gray-800 me-2">{{ this.company?.data?.contact_number }} </span>
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Label-->
                        <div class="col-lg-8">
                            <span class="fw-semibold fs-6 text-gray-800">{{ this.company?.data?.corporationtype }}</span>
                        </div>
                        <!--begin::Label-->
                    </div>
                    <!--end::Input group-->
