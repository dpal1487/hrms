...
<template>
    ...
    <AppLayout :title="isEdit ? 'Edit Period' : `Add New Period`">
        <template #breadcrumb>
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">Time Period Form</span>
            </li>
        </template>
        <form @submit.prevent="submit()" class="form d-flex flex-column flex-lg-row g-5 mx-5">
            <div class="col-6 card">
                <div class="card-header">
                    <div class="card-title">
                        <h2>Time Period Form</h2>
                    </div>
                </div>
                <div class="card-body pt-5">
                            ...
                            <div class="row align-items-center">
                                <div v-for='(time_period, index) in form.time_periods'
                                    ...
                                    <div class="w-100 position-relative">
                                        <Multiselect :canClear="false" :options="times?.data" label="title" valueProp="id"
                                            class="form-control form-control-lg form-control-solid" placeholder="Select One"
                                            v-model="time_period.id" track-by="label" />
                    ...
                    <div class="d-flex justify-content-end">
                        <Link href="/time-periods" class="btn btn-outline-secondary me-5">
                        Discard
                        </Link>
