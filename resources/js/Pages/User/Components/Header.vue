    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-body pt-9 pb-0">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <Link
                        :class="`nav-link text-active-primary ms-0 me-10 py-5 ${route().current('user.reviews') && 'active'}`"
                        :href="`/user/${user?.id}/reviews`">Reviews
                    </Link>
                </li>
                <li class="nav-item mt-2">
                    <Link
                        :class="`nav-link text-active-primary ms-0 me-10 py-5 ${route().current('user.packages') && 'active'}`"
                        :href="`/user/${user?.id}/packages`">Packages
                    </Link>
                </li>
                <li class="nav-item mt-2">
                    <Link
                        :class="`nav-link text-active-primary ms-0 me-10 py-5 ${route().current('user.reports') && 'active'}`"
