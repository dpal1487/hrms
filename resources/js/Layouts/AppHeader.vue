                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/referrals.html" class="menu-link px-5">
                                            Referrals
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/billing.html" class="menu-link px-5">
                                            Billing
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/statements.html" class="menu-link px-5">
                                            Payments
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/statements.html"
                                            class="menu-link d-flex flex-stack px-5">
                                            Statements

                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                aria-label="View your statements"
                                                data-bs-original-title="View your statements" data-kt-initialized="1"></i>
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/settings.html" class="menu-link d-flex px-5 active">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/../demo1/account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="/assets/account/settings.html" class="menu-link px-5">
                                    Account Settings
                                </a>
                            </div>
                            <!--end::Menu item-->
