...
export default defineComponent({
    ...
    methods: {
        listenForChanges() {
            // window.Echo.channel('project-created') //Should be Channel Name
    ...
    <div id="kt_app_header" class="app-header">
        <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
            ...
            <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu">
                <button @click="$emit('setSidebar', true)" class="btn btn-icon btn-active-color-primary w-35px h-35px"
            ...
            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                <!--begin::Menu wrapper-->
                <div class="app-header-menu app-header-mobile-drawer"></div>
                <!--end::Menu wrapper-->
                <!--begin::Navbar-->
                        ...
                        <div aria-labelled:by="dropdown-profile"
                            ...
                            <div class="menu-item px-5">
                                <form method="post" @submit.prevent="logout">
                                    <button type="submit" class="btn btn-sm menu-link px-5"
