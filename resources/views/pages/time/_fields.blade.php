   ...
   <div class="card-body pt-0">
           ...
           <div class="mb-10 fv-row col-6">
               ...
               <div class="">
                   <select class="form-select mb-2" name="status" data-control="select2"
                       ...
                       <option value="1" @selected(@$time->status == '1')>Active</option>
                       <option value="0" @selected(@$time->status == '0')>Inactive</option>
                   </select>
       ...
       <div class="row">
           <div class="fv-row mb-2">
               ...
               <textarea name="description" class="form-control">{{ @$time->description }}</textarea>
